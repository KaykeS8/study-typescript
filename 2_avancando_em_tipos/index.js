...
const frases = ['Desenvolvedor Front-end', 'Desenvolvedor back-end', 'Desenvolvedor full-stack'];
frases.push('Dev ops');
console.log(frases);
...
// 3 - any
const arr1 = ['Vagas aberta', 'A falência', 122, 'Revolução do bichos', 'Mais esperto que o diabo', true, {
        nome: 'Julia',
        idade: 19
    }];
arr1.push([234, '', 345]);
...
const novaArray = ['nome', 34, false, { nome: 'kayke' }];
